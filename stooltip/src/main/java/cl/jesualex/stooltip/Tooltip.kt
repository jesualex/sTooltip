...
class Tooltip private constructor(private val activity: Activity, private val refView: View, private val rootView: View?){
    ...
    internal var lineHeightMultiplier = getTextView().lineSpacingMultiplier
    internal var lineHeightAdd = getTextView().lineSpacingExtra
    ...
    @JvmOverloads fun show(duration: Long = 0, text: String? = null): Tooltip{
        refView.post {
            ...
            getTextView().setLineSpacing(lineHeightAdd, lineHeightMultiplier)
